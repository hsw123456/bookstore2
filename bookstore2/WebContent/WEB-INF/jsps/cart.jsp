...
<body>
	...
	<center>
		...
		<br><br>
		<div id="bookNumber">您的购物车中共有 ${shoppingCart.bookNumber } 本书</div>
		<table cellpadding="10">
			...
			<s:iterator value="#session.shoppingCart.items" var="item">
				<tr>
					...
					<td><a href="bookstore_removeItem?pageNum=${pageNum }&id=${item.book.id }" class="delete">删除</a></td>
				</tr>
			</s:iterator>
			
			<tr>
				<td colspan="4" id="totalMoney">总金额:￥ ${ shoppingCart.totalMoney}</td>
			</tr>
			
			<tr>
				<td colspan="4">
					<a href="bookstore_list.action?pageNum=${pageNum}">继续购物</a>
					&nbsp;&nbsp;
					
					<a href="bookstore_clearCart.action">清空购物车</a>
					&nbsp;&nbsp;
					
					<a href="bookstore_toCash.action">结账</a>
					&nbsp;&nbsp;
				</td>
			</tr>
